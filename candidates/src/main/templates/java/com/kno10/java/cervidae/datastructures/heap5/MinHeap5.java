 ...
 */
public class ${Type}MinHeap5${def-generics} implements ${parent-Type}Heap${use-generics} {
  /**
   * Heap storage.
   */
   ...
   */
  ${unchecked}
  public ${Type}MinHeap5(${extra-constructor}) {
    super();
   ...
   */
  ${unchecked}
  public ${Type}MinHeap5(int minsize, ${extra-constructor}) {
    super();
    ${extra-constructor-init}
  ...
  public String toString() {
    ...
    buf.append(${Type}MinHeap5.class.getSimpleName()).append(" [");
