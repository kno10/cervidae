 ...
 */
public class ${Type}MaxHeap3Loop${def-generics} implements ${parent-Type}Heap${use-generics} {
  /**
   * Heap storage.
   */
   ...
   */
  ${unchecked}
  public ${Type}MaxHeap3Loop(${extra-constructor}) {
    super();
   ...
   */
  ${unchecked}
  public ${Type}MaxHeap3Loop(int minsize, ${extra-constructor}) {
    super();
    ${extra-constructor-init}
  ...
  private void heapifyDown3(int pos, ${rawtype} cur) {
    ...
    while (pos < stop) {
      ...
      for (int i = 0; i < 2 && candidate < size; i++, candidate++) {
  ...
  public String toString() {
    ...
    buf.append(${Type}MaxHeap3Loop.class.getSimpleName()).append(" [");
