 ...
 */
public class ${Type}MinHeap24${def-generics} implements ${parent-Type}Heap${use-generics} {
  /**
   * Base heap.
   */
   ...
   */
  ${unchecked}
  public ${Type}MinHeap24(${extra-constructor}) {
    super();
   ...
   */
  ${unchecked}
  public ${Type}MinHeap24(int minsize, ${extra-constructor}) {
    super();
    ${extra-constructor-init}
  ...
  public String toString() {
    ...
    buf.append(${Type}MinHeap24.class.getSimpleName()).append(" [");
