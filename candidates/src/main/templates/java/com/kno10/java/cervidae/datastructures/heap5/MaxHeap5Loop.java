 ...
 */
public class ${Type}MaxHeap5Loop${def-generics} implements ${parent-Type}Heap${use-generics} {
  /**
   * Heap storage.
   */
   ...
   */
  ${unchecked}
  public ${Type}MaxHeap5Loop(${extra-constructor}) {
    super();
   ...
   */
  ${unchecked}
  public ${Type}MaxHeap5Loop(int minsize, ${extra-constructor}) {
    super();
    ${extra-constructor-init}
  ...
  public String toString() {
    ...
    buf.append(${Type}MaxHeap5Loop.class.getSimpleName()).append(" [");
