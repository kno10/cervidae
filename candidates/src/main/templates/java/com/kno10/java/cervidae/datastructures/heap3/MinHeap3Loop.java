 ...
 */
public class ${Type}MinHeap3Loop${def-generics} implements ${parent-Type}Heap${use-generics} {
  /**
   * Heap storage.
   */
   ...
   */
  ${unchecked}
  public ${Type}MinHeap3Loop(${extra-constructor}) {
    super();
   ...
   */
  ${unchecked}
  public ${Type}MinHeap3Loop(int minsize, ${extra-constructor}) {
    super();
    ${extra-constructor-init}
  ...
  public String toString() {
    ...
    buf.append(${Type}MinHeap3Loop.class.getSimpleName()).append(" [");
